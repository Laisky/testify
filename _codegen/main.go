...
var (
	pkg       = flag.String("assert-path", "github.com/Laisky/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/Laisky/testify/_codegen
